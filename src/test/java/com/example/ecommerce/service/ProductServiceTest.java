...
class ProductServiceTest {
    ...
    void createProduct_SavesAndReturnsCorrectDTO() {
        ...
        Product savedProduct = easyRandom.nextObject(Product.class);
    ...
    void updateProduct_UpdatesAndReturnsDTO() {
        ...
        Product updatedProduct = easyRandom.nextObject(Product.class);
        ProductDTO updateDto = easyRandom.nextObject(ProductDTO.class);
